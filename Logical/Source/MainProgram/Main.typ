...
TYPE
	...
	ParametersType : 	STRUCT 
		...
		Tank3MaxAllowedPressure : REAL; (*Max allowed pressure for tank 3*)
		Tank3MaxAllowedTemp : REAL; (*Max allowed temperature for tank 3*)
		Tank3LeftValveOpeningLvl : UINT := 0; (*Opening level to set for tank 3 left valve*)
		...
		Tank3MaxAllowedFluidLvl : INT; (*Tank 3 max allowed fluid level to set*)
		Tank2MaxAllowedFluidLvl : INT; (*Tank 2 max allowed fluid level to set*)
		Tank1MaxAllowedFluidLvl : INT; (*Tank 1 max allowed fluid level to set*)
		Mixer1MaxAllowedVelocity : INT; (*Mixer 1 max allowed velocity to set*)
		Mixer2MaxAllowedVelocity : INT; (*Mixer 2 max allowed velocity to set*)
